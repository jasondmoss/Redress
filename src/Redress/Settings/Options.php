...
class Options
{
     ...
     * @access public
     */
    public function redressOptionsPage()
    {
        ?>

<div class="wrap">
  <h2><?php _e("Redress <small>(v{$this->version})</small> Options", 'redress'); ?></h2><hr>
  ...
  */ ?>
     ...
     * @access public
     */
    public function redressOptions()
    {
        $this->generalSection();
        $this->modulesSection();
    }
