...
class Development
{
    ...
    public function __construct($isDevelopment)
    {
         ...
         * Development check.
         *
         * @see {WP_ROOT}/wp-config.php
         */
        if ($this->devel) {
            /**
             * Record any of WordPress' plugin activation errors to an HTML
             * file, as the debugging/error reporting functionality of
             * WordPress, even on its best day, leaves much to desire.
             */
     ...
     * @access public
     */
    public function printDevServerCommentMessage()
    {
        echo <<<MSG
...
MSG;
     ...
     * @access public
     */
    public function displayDevelopmentBar()
    {
        switch ($_SERVER['HTTP_HOST']) {
            // case 'remote.development.server':
            //     $server = '&#160;&#160;(My Remote Dev Server)';
            //     break;
     ...
     * @access public
     */
    public function printRewriteRules()
    {
        global $wp_rewrite;
     ...
     */
    public function dump($var, $label = '', $exit = false)
    {
